...
function SectionHeader({
  ...
  return (
    <div className="flex items-center justify-end gap-2.5 flex-shrink-0" style={{ marginBottom: '8px' }}>
      <span className="text-sm font-black tracking-wide text-white">{title}</span>
      <div
